...
def main(pretrained_model_name_or_path="xmg2024/YamerMIX_v8", enable_lcm_arg=False):
    ...
    📧 **Contact**
    <br>
    If you have any questions, please feel free to open an issue or directly reach us out at <b>112265ml@gmail.com</b>.
    """
        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                usage_tips = gr.Markdown(
                    label="Image2ID Usage Tips", value=tips, visible=False
                )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--pretrained_model_name_or_path", type=str, default="xmg2024/YamerMIX_v8"
    )
    parser.add_argument(
