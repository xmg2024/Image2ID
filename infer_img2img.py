...
from pipeline_stable_diffusion_xl_image2id_img2img import StableDiffusionXLImage2IDImg2ImgPipeline, draw_kps
...
if __name__ == "__main__":
    ...
    pipe = StableDiffusionXLImage2IDImg2ImgPipeline.from_pretrained(
        base_model_path,
